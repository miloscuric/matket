...
public class Artikal implements Serializable {
	...
	public Artikal(String sifra, String naziv, String opis, String vrsta) {
		super();
		this.sifra = sifra;
		this.naziv = naziv;
		this.opis = opis;
	...
	public Artikal(String sifra, String naziv, String opis, String vrsta, JedinicaMere jedinicaMere,
